...
const newTh = {
  ...
  about: {
    ...
    team: {
      ...
      members: [
        {
          "name": "คุณอัฐเชษฐ์ ทองชัช",
          "role": "กรรมการผู้บริหาร",
          "expertise": "การวางแผนกลยุทธ์และการบริหารภาพรวม",
          "experience": "ประสบการณ์ในการบริหารองค์กร",
        ...
        {
          "name": "คุณธีรภัทร์ ทองเครือ",
          "role": "ฝ่ายปฏิบัติการด้าน Subscription",
          "expertise": "การจัดการซอฟแวร์",
          "experience": "มีประสบการณ์ทางด้านซอฟแวร์มานับไม่ถ้วน",
          "desc": "บริหารจัดการขั้นตอนการทำซอฟแวร์และเซิร์ฟเวอร์ ตรวจสอบความถูกต้อง และส่งมอบงานตรงตามกำหนดเวลาให้กับลูกค้าทุกราย",
          "quote": "\"ความแม่นยำในรายละเอียดช่วยป้องกันปัญหาใหญ่ในอนาคต\""
        },
        {
          "name": "คุณสรวงพรรณ ศรีเปี่ยมลาภ",
          "role": "ผู้เชี่ยวชาญด้านที่ปรึกษา",
          "expertise": "การบริการสมาชิกและลูกค้าสัมพันธ์",
          "experience": "ประสบการณ์กว่า 10 ปีในการเป็นที่ปรึกษาให้กับบริษัทในทุกด้าน",
